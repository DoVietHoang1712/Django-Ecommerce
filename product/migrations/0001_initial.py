    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='product.book')),
                ('clothes', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='product.clothes')),
                ('electronic', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='product.electronic')),
                ('laptop', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='product.laptop')),
            ],
        ),
    ]
